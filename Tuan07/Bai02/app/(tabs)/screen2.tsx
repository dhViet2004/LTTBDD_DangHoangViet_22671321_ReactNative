...
import { View, Text, FlatList, StyleSheet, TextInput, TouchableOpacity, SafeAreaView, ActivityIndicator } from 'react-native';
...
export default function TaskScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      fetch('https://68fb388194ec960660251c2e.mockapi.io/tasks')
        .then(res => res.json())
  ...
  const toggleCompleted = async (task: Task) => {
    ...
    try {
      const response = await fetch(`https://68fb388194ec960660251c2e.mockapi.io/tasks/${task.id}`, {
        method: 'PUT',
